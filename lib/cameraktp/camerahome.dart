...
class CameraHomePage extends StatefulWidget {
  const CameraHomePage({Key? key, required this.cameras}) : super(key: key);
...
class _CameraHomePageState extends State<CameraHomePage> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      ...
      navfoto = prefs.getString('fototambah')!;
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            ...
                            setState(() async {
                              ...
                              SharedPreferences prefs = await SharedPreferences.getInstance();
                              prefs.setString("fotoimage", img64foto);

                              if (navfoto == "info") {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => Tambahnewspage()));
                              } else if (navfoto == "donasi") {
                                Navigator.push(
                                    context,
                                    MaterialPageRoute(
                                        builder: (context) => TambahKeuanganpage()));
