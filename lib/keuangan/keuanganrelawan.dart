...
class KeuangaRelawannpage extends StatefulWidget {
  const KeuangaRelawannpage({Key? key}) : super(key: key);

  @override
  State<KeuangaRelawannpage> createState() => _KeuanganpageState();
}

class _KeuanganpageState extends State<KeuangaRelawannpage> {
                                                  ...
                                                  children: [
                                                    ...
                                                    "keuhp"] ==
                                                      ...
                                                      IconButton(
                                                        onPressed:
                                                            () {
                                                          dialogdeleteinfo(filteredItemdonasi[index]["idk"]);
                                                        },
                                                        icon:
                                                        Icon(
  ...
  Future dialogdeleteinfo(String idk) {
    return showDialog(
        context: context,
