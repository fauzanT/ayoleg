...
class PrivacyPolicyRegister extends StatefulWidget {
  const PrivacyPolicyRegister({Key? key}) : super(key: key);

  @override
  State<PrivacyPolicyRegister> createState() => _PrivacyPolicyRegisterState();
}

class _PrivacyPolicyRegisterState extends State<PrivacyPolicyRegister> {
  bool check = false;
...
by You on any electronic device, named Ayoscan

* Company (referred to as either "the Company", "We", "Us" or "Our" in this
Agreement) refers to Ayoscan.
            ...
            children: [
              Expanded(
                child: Container(
                  ...
                  child: Container(
                      ...
                      //   zoomEnabled: false,
                      //   initialUrl:
                      //       'https://www.privacypolicies.com/live/d847b264-a22a-4c0b-8d35-f3106701ecd4',
              ...
              InkWell(
                onTap: () async {
                  if (check == true) {
                     Navigator.push(
        context, MaterialPageRoute(builder: (context) => PReviewIamgePage()));
                  }
                },
                child: Container(
                    width: 200,
                    ...
                    decoration: BoxDecoration(
                      borderRadius: BorderRadius.circular(10),
                      color: check ? greenPrimary : Colors.grey,
                    ),
                    child: Center(
                        child: Text(
                      "Saya Menyetujui",
