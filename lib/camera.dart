...
class CameraWajah extends StatefulWidget {
  const CameraWajah({Key? key, required this.cameras}) : super(key: key);

  final List<CameraDescription>? cameras;

  @override
  State<CameraWajah> createState() => _CameraWajahState();
}

class _CameraWajahState extends State<CameraWajah> {
                        ...
                        child: IconButton(
                          ...
                          onPressed: () async {
                            ...
                            setState(() async {
                              ...
                              prefs.setString("fotoregister", img64foto);
                              Navigator.push(
                                  context,
                                  MaterialPageRoute(
