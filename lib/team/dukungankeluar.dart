...
class DukunganKeluarpage extends StatefulWidget {
  const DukunganKeluarpage({Key? key}) : super(key: key);

  @override
  State<DukunganKeluarpage> createState() => _DukunganKeluarpageState();
}

class _DukunganKeluarpageState extends State<DukunganKeluarpage> {
  ...
  void initState() {
    ...
    SharedPreferences.getInstance().then((prefs) {
      ...
      _baseUrlpendukung =
          'http://aplikasiayocaleg.com/ayocalegapi/getdukungankeluar.php?usrkc=' +
              kodecaleg;
                                                          ...
                                                          Container(
                                                              ...
                                                              child: filteredItemspendukung[
                                                                  ...
                                                                  : filteredItemspendukung[index]
                                                                      ...
                                                                      : filteredItemspendukung[index]['usrsts'] ==
                                                                              "P"
                                                                          ? Text(
                                                                              "Pendukung",
                                                                              style: TextStyle(
                                                                          ...
                                                                          : filteredItemspendukung[index]['usrsts'] == "S"
                                                                              ? Text(
                                                                                  "Saksi",
                                                                                  style: TextStyle(
                                                                                    fontSize: 10,
  ...
  cektotaktifasi() async {
    ...
    if (response.statusCode == 200) {
      ...
      if (jsonResponse != null) {
        setState(() {
          totd = jsonResponse['jumlahtidakaktif'];
        });
      }
    }
  }
