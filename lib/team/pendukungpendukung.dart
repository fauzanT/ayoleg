...
class PendukungPendukungpage extends StatefulWidget {
  const PendukungPendukungpage({Key? key}) : super(key: key);

  @override
  State<PendukungPendukungpage> createState() => _PendukungPendukungpageState();
}

class _PendukungPendukungpageState extends State<PendukungPendukungpage> {
  ...
  Future<List<Datapendukungpendukung>>? futurpendukunggg;
  ...
  void initState() {
    SharedPreferences.getInstance().then((prefs) {
      ...
      nohppendukungpendukung = prefs.getString('nohppendukungpendukungg')!;
      // futurpendukunggg = fetchGetDataPendukungPendukung(nohppendukungpendukung);
      _baseUrlpendukung =
          'http://aplikasiayocaleg.com/ayocalegapi/getpendukung2.php?usrkp=' +
              nohppendukungpendukung;
      cektotpendukung();
  ...
  cektotpendukung() async {
    ...
    String nohprelawann = prefs.getString('nohppendukungpendukungg')!;
    Map data = {
      'usrkc': kodecaleg,
      'usrkp': nohprelawann,
    };
